...
class MarriottRoom:
    def __init__(self, room_type, avaliable, price_per_night, date_from, date_to):
...
class MarriottHotelAPI:
    @staticmethod
    def search_available_rooms(location, from_date, to_date, adults, children, neededrooms):
        rooms = []
